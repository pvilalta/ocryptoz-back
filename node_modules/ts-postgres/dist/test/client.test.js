...
;
describe('Events', () => {
    helper_1.testWithClient('End', (client) => __awaiter(void 0, void 0, void 0, function* () {
        expect.assertions(1);
        const f = jest.fn();
        client.on('end', f);
    ...
    helper_1.testWithClient('Connect', (client) => __awaiter(void 0, void 0, void 0, function* () {
...
describe('Query', () => {
    helper_1.testWithClient('Without parameters', (client) => __awaiter(void 0, void 0, void 0, function* () {
        expect.assertions(1);
        const query = new query_1.Query('select 1');
        const result = yield client.query(query);
        expect(result.rows.length).toEqual(1);
    }));
    helper_1.testWithClient('With parameters', (client) => __awaiter(void 0, void 0, void 0, function* () {
        expect.assertions(1);
        const query = new query_1.Query('select $1::int', [1]);
        const result = yield client.query(query);
        expect(result.rows.length).toEqual(1);
    }));
    helper_1.testWithClient('Named portal', (client) => __awaiter(void 0, void 0, void 0, function* () {
        expect.assertions(1);
        const query = new query_1.Query('select $1::int', [1]);
        const result = yield client.query(query);
        expect(result.rows.length).toEqual(1);
    }));
    helper_1.testWithClient('Custom value type reader', (client) => __awaiter(void 0, void 0, void 0, function* () {
        expect.assertions(5);
    ...
    helper_1.testWithClient('Prepared statement', (client) => __awaiter(void 0, void 0, void 0, function* () {
        const count = 5;
    ...
    helper_1.testWithClient('Listen/notify', (client) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    helper_1.testWithClient('Cursor', (client) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    helper_1.testWithClient('Query errors become promise rejection', (client) => __awaiter(void 0, void 0, void 0, function* () {
        yield expect(client.query('select foo')).rejects.toThrow(/foo/);
    }));
    helper_1.testWithClient('Query errors plays nicely with pipeline', (client) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const go = (remaining) => __awaiter(void 0, void 0, void 0, function* () {
            if (remaining === 0)
    ...
    helper_1.testWithClient('Empty query', (client) => __awaiter(void 0, void 0, void 0, function* () {
        yield expect(client.query('')).resolves.toEqual({ names: [], rows: [], status: null });
    }));
    helper_1.testWithClient('Unsupported type', (client) => __awaiter(void 0, void 0, void 0, function* () {
        const text = 'select $1::internal';
        yield expect(client.query(text, [''])).rejects.toThrow(/2281/);
    }));
    helper_1.testWithClient('Prepare and execute', (client) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    helper_1.testWithClient('Transaction', (client) => __awaiter(void 0, void 0, void 0, function* () {
        yield client.query('BEGIN');
        yield client.query('CREATE TABLE posts (author text, postcount int)');
        const authors = [
            { author: 'john', count: 10 },
            { author: 'john', count: 10 },
        ];
        yield Promise.all(authors.map(x => client.query('INSERT INTO posts (author, postcount) VALUES ($1, $2)', [x.author, x.count])));
        const output = yield client.query(`SELECT SUM(postcount) AS total_comments, author
                 FROM posts GROUP BY author`);
        expect(output.rows[0][0]).toEqual(BigInt(20));
        yield client.end();
    }));
