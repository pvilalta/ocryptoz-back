...
describe('Result', () => {
    ...
    helper_1.testWithClient('Parse array containing null', (client) => __awaiter(void 0, void 0, void 0, function* () {
        expect.assertions(1);
        let row = yield client.query('select ARRAY[null::text] as a').one();
    ...
    helper_1.testWithClient('Format array containing null value', (client) => __awaiter(void 0, void 0, void 0, function* () {
        expect.assertions(1);
        let row = yield client.query('select $1::text[] as a', [[null]]).one();
        expect(row.get('a')).toEqual([null]);
    }));
    ...
    helper_1.testWithClient('Multiple null params', (client) => __awaiter(void 0, void 0, void 0, function* () {
        expect.assertions(3);
        let row = yield client.query('select $1::text as a, $2::text[] as b, $3::jsonb[] as c', [null, null, null]).one();
    ...
    helper_1.testWithClient('Null typed array', (client) => __awaiter(void 0, void 0, void 0, function* () {
        expect.assertions(1);
        let row = yield client.query('select null::text[] as value').one();
