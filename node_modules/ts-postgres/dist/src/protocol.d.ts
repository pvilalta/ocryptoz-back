...
export declare function readRowData(buffer: Buffer, rowDataOffset: number, rowDescription: RowDescription, encoding: BufferEncoding, types: ReadonlyMap<DataType, ValueTypeReader> | null): ArrayValue<Primitive>;
...
export declare class Writer {
    ...
    private outgoing;
    constructor(stream: Socket, encoding: BufferEncoding);
